...
void setup() {
  ...
  #else
  Serial.println("leemos eeprom");
    readEEPROM();                 
    Serial.println("acabamos de leemos eeprom");
  ...
  Serial.println("leemos globalset");
  readGlobalSet();                              // reload global settings for get last profile number
  Serial.println("acabamos leemos global set");
  #ifndef NO_FLASH_CHECK
  ...
  #endif
  Serial.println("leemos eeprom otra vez");
  readEEPROM();                                 // load setting data from last used profile
  Serial.println("acamos leemos eeprom otra vez");
